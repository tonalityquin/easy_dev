...
class _AppStartTutorialLabScreenState extends State<AppStartTutorialLabScreen>
  ...
  Future<void> _requestMicrophone() async {
    ...
    try {
      ...
      setState(() => _microphoneStatus = s);
      if (!s.isGranted) {
        await _showNeedPermissionDialog('마이크(무전 송신)');
      }
    } finally {
      if (!mounted) return;
      setState(() => _busy = false);
  ...
  Widget _buildScrollableStep(BuildContext context, Widget child) {
          ...
          Column(
            ...
            children: [
              ...
              _buildPermissionCard(
                ...
                onRequest: () async => _requestNotifications(),
              ),
            ],
          ),
        );
          ...
          Column(
            ...
            children: [
              ...
              _buildPermissionCard(
                ...
                onRequest: () async => _requestLocation(),
              ),
            ],
          ),
        );
          ...
          Column(
            ...
            children: [
              ...
              _buildPermissionCard(
                ...
                onRequest: () async => _requestBattery(),
              ),
            ],
          ),
        );
          ...
          Column(
            ...
            children: [
              ...
              _buildPermissionCard(
                ...
                onRequest: () async => _requestCamera(),
              ),
            ],
          ),
        );
          ...
          Column(
            ...
            children: [
              ...
              _buildPermissionCard(
                ...
                onRequest: () async => _requestOverlay(),
                onOpenSettings: () async => _openOverlaySettingsHint(),
              ),
            ],
          ),
        );
          ...
          Column(
            ...
            children: [
              ...
              _buildPermissionCard(
                ...
                onRequest: () async => _requestMicrophone(),
              ),
            ],
          ),
        );
