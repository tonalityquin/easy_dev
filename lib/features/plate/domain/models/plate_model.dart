...
String _locationFullFromFirestore(dynamic raw) {
  if (raw is Map) {
...
class PlateModel {
  ...
  factory PlateModel.fromDocument(DocumentSnapshot<Map<String, dynamic>> doc) {
    ...
    return PlateModel(
      ...
      area: data[PlateFields.area] ?? _kLocUnknown,
      ...
      location: _locationFullFromFirestore(data[PlateFields.location]),
  ...
  Map<String, dynamic> toMap({bool removeNullOrEmpty = false}) {
    final map = <String, dynamic>{
      ...
      PlateFields.location: _locationToMap(location),
  ...
  Map<String, dynamic> diff(PlateModel other) {
    ...
    if (addStandard != other.addStandard) {
      changes['addStandard'] = {
        'before': addStandard,
        'after': other.addStandard
      };
    }
    if (basicAmount != other.basicAmount) {
      changes['basicAmount'] = {
        'before': basicAmount,
        'after': other.basicAmount
      };
    }
    if (basicStandard != other.basicStandard) {
      changes['basicStandard'] = {
        'before': basicStandard,
        'after': other.basicStandard
      };
    }
    ...
    if (customStatus != other.customStatus) {
      changes['customStatus'] = {
        'before': customStatus,
        'after': other.customStatus
      };
    }
    ...
    if (regularAmount != other.regularAmount) {
      changes['regularAmount'] = {
        'before': regularAmount,
