...
import '../sheets/widgets/keypad/kor_keypad.dart';
import '../sheets/widgets/keypad/num_keypad.dart';
...
class _MonthlyPlateBottomSheetState extends State<MonthlyPlateBottomSheet> {
  ...
  void _populateFields(Map<String, dynamic> data) {
    ...
    _regularDurationController.text =
        (data['regularDurationHours'] ?? '').toString();
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            MonthlyPlateSection(
                              ...
                              controllerBackDigit:
                                  controller.controllerBackDigit,
                              activeController: controller.activeController,
                              onKeypadStateChanged: (tc) {
                                setState(
                                    () => controller.setActiveController(tc));
                              },
