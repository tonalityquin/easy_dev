...
import '../../widgets/calendar/board_kanban_view.dart';
import '../../widgets/calendar/calendar_model.dart';
import '../../widgets/calendar/completed_events_sheet.dart';
import '../../widgets/calendar/event_editor_bottom_sheet.dart';
    ...
    final btn = FilledButton.icon(
      ...
      icon: loading
        ...
        child: CircularProgressIndicator(
            strokeWidth: 2, color: tokens.onAccent),
      )
                    ...
                    children: [
                      ...
                      if (value.text.isNotEmpty && !locked)
                        IconButton(
                          ...
                          onPressed: onClear,
                          icon:
                          Icon(Icons.clear, color: tokens.onSurfaceVariant),
                          iconSize: 20,
                          visualDensity: VisualDensity.compact,
                          padding: EdgeInsets.zero,
                          constraints: const BoxConstraints.tightFor(
