...
import '../../../../../screens/triple_mode/type_package/common_widgets/dashboard_bottom_sheet/triple_hq_dash_board_page.dart';
...
class TripleDashBoard extends StatelessWidget {
  ...
  double _calcTagImageHeight(BuildContext context) {
    ...
    return fontSize + _kTagExtraHeight;
  }
  ...
  Widget build(BuildContext context) {
    ...
    final tagImageHeight = _calcTagImageHeight(context);
                ...
                IgnorePointer(
                  child: Align(
                    ...
                    child: Padding(
                      ...
                      child: Semantics(
                        label: 'screen_tag: TripleDashBoard C',
