...
class DoubleHomeDashBoardBottomSheet extends StatefulWidget {
  ...
  @override
  State<DoubleHomeDashBoardBottomSheet> createState() =>
      _DoubleHomeDashBoardBottomSheetState();
}

class _DoubleHomeDashBoardBottomSheetState
    extends State<DoubleHomeDashBoardBottomSheet> {
  ...
  void _onPhotoTransferPressed(BuildContext context) {
    ...
    rootNav
        .push(MaterialPageRoute(builder: (_) => const PhotoTransferMailPage()));
  }
  ...
  Widget _buildFixedHeader(
    ...
    return Column(
      children: [
        ...
        DoubleDashboardInsidePunchRecorderSection(
