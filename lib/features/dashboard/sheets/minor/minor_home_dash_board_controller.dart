...
class MinorHomeDashBoardController {
  Future<void> handleWorkStatus(
    ...
    if (!userState.isWorking) {
      debugPrint(
        '[MinorHomeDashBoardController] work_status_ignored reason=clock_in_requires_common_gate',
      );
      return;
    }
    ...
    if (!result.success) {
      debugPrint(
        '[MinorHomeDashBoardController] clock_out_failed message=${result.message}',
      );
    }
  }
