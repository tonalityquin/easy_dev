                    ...
                    Expanded(
                      child: ListView(
                        ...
                        children: [
                                ...
                                children: isRegular
                                    ...
                                    : [
                                        ...
                                        _buildInfoRow(
                                            context,
                                            '기본 시간',
                                            _formatMinutesToHourMinute(
                                                widget.basicStandard)),
                                        _buildInfoRow(context, '기본 금액',
                                        ...
                                        _buildInfoRow(
                                            ...
                                            _formatMinutesToHourMinute(
                                                widget.addStandard)),
                                        _buildInfoRow(context, '추가 금액',
                                            '₩${formatCurrency.format(widget.addAmount)}'),
                                        _buildInfoRow(context, '주차 시간',
                                            _getFormattedParkedTime()),
                                        _buildInfoRow(context, '요금 모드 적용 전 금액',
                          ...
                          Row(
                            children:
                                List.generate(FeeMode.values.length, (index) {
                              final selected =
                            ...
                            Container(
                              ...
                              child: TextField(
                                ...
                                decoration: InputDecoration(
                                  labelText: _feeMode == FeeMode.plus
                                      ? '할증 금액 입력'
                                      : '할인 금액 입력',
                                  filled: true,
                                  ...
                                  ? () {
                                      ...
                                      Navigator.of(context).pop(
                                        BillResult(
                                          ...
                                          reason: _feeMode == FeeMode.normal
                                              ? null
                                              : _inputReason,
                                        ),
                                      );
