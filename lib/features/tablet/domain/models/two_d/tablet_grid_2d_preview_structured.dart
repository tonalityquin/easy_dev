part of 'tablet_grid_2d_preview.dart';

extension _ParkingGridStructuredPreviewPart on _TabletGrid2dPreviewState {
    ...
    return ClipRRect(
      ...
      child: DecoratedBox(
        ...
        child: _withSwipeAffordance(
          index: index,
          count: count,
          child: _TabletGrid2DView(model: model, palette: palette),
        ),
      ),
    );
  }
...
class _TabletGrid2DView extends StatefulWidget {
  final _ParkingGridModel model;
  final _ModelPalette palette;

  const _TabletGrid2DView({
    required this.model,
    required this.palette,
  });

  @override
  State<_TabletGrid2DView> createState() => _TabletGrid2DViewState();
}

class _TabletGrid2DViewState extends State<_TabletGrid2DView>
