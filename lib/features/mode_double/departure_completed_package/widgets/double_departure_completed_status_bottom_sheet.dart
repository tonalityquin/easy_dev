...
Future<PlateModel?> showDoubleDepartureCompletedStatusBottomSheet({
  ...
  trace.log(
    '[DoubleDepartureStatus] presentation=right_side_dock direction=right_to_left plate=${plate.plateNumber} area=${plate.area}',
    progress: .16,
  );
  ...
  while (context.mounted) {
    ...
    final result = await showParkingStatusSideDock<PlateModel>(
      ...
      builder: (_) => _DoubleDepartureCompletedStatusDock(
        plate: currentPlate,
        performedBy: who,
        onChanged: (updated) {
          latestPlate = updated;
...
class _DoubleDepartureCompletedStatusDock extends StatefulWidget {
  const _DoubleDepartureCompletedStatusDock({
    required this.plate,
  ...
  @override
  State<_DoubleDepartureCompletedStatusDock> createState() =>
      _DoubleDepartureCompletedStatusDockState();
}

class _DoubleDepartureCompletedStatusDockState
    extends State<_DoubleDepartureCompletedStatusDock> {
