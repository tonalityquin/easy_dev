...
class DoubleParkingCompletedPlateNumberDisplay extends StatelessWidget {
  final TextEditingController controller;
  final bool Function(String) isValidPlate;

  const DoubleParkingCompletedPlateNumberDisplay({
    super.key,
                    ...
                    child: Center(
                      child: Text(
                        ...
                        style: TextStyle(
                          ...
                          color: char.isEmpty ? cs.onSurfaceVariant.withOpacity(0.45) : cs.onSurface,
                        ),
                      ),
                    ),
                  ),
