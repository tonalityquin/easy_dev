...
void _traceAttendancePunch(
  ...
  DebugActionRecorder.instance.recordAction(
    ...
    meta: <String, dynamic>{
      'screen': 'common_attendance_punch_feedback',
...
Future<void> showCommonAttendancePunchFeedback(
  BuildContext context, {
  required AttBrkModeType type,
  required DateTime dateTime,
  required bool requiresBreak,
}) async {
  _traceAttendancePunch(context, type, dateTime);
  ...
  await showGeneralDialog<void>(
    ...
    barrierLabel: 'common_attendance_punch_feedback',
                                    ...
                                    children: [
                                      ...
                                      Expanded(
                                        ...
                                        child: _PunchStatusCell(
                                          ...
                                          label: '퇴근',
                                          accentColor: _accentColorForType(
                                              context, AttBrkModeType.workOut),
                                          highlighted: widget.type ==
