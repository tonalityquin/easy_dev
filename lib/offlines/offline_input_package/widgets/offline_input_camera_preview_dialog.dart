...
class OfflineInputCameraPreviewDialog extends StatefulWidget {
  final void Function(List<XFile>)? onCaptureComplete;
  final void Function(XFile)? onImageCaptured;

  const OfflineInputCameraPreviewDialog({
    super.key,
  ...
  @override
  State<OfflineInputCameraPreviewDialog> createState() =>
      _OfflineInputCameraPreviewDialogState();
}

class _OfflineInputCameraPreviewDialogState extends State<OfflineInputCameraPreviewDialog> {
