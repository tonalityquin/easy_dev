...
class OfflineInputAnimatedActionButton extends StatefulWidget {
  final bool isLoading;
  final bool isLocationSelected;
  final Future<void> Function() onPressed;
  final String? buttonLabel;

  const OfflineInputAnimatedActionButton({
    super.key,
  ...
  @override
  State<OfflineInputAnimatedActionButton> createState() => _OfflineInputAnimatedActionButtonState();
}

class _OfflineInputAnimatedActionButtonState extends State<OfflineInputAnimatedActionButton>
