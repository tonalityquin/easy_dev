...
import 'offline_states/page/offline_hq_state.dart';
...
class OfflineHeadPage extends StatelessWidget {
  const OfflineHeadPage({super.key});

  @override
  Widget build(BuildContext context) {
    return MultiProvider(
      providers: [
        ChangeNotifierProvider(create: (_) => OfflineHqState(pages: hqPage)),
      ],
      child: Builder(
        builder: (context) {
          return PopScope(
...
class _BottomArea extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final state = context.watch<OfflineHqState>();
...
class PageBottomNavigation extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return Consumer<OfflineHqState>(
      builder: (context, state, child) {
        final pages = state.pages;
