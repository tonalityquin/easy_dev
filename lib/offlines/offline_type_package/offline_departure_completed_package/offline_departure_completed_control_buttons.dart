...
class OfflineDepartureCompletedControlButtons extends StatefulWidget {
  ...
  const OfflineDepartureCompletedControlButtons({
    super.key,
  ...
  @override
  State<OfflineDepartureCompletedControlButtons> createState() => _OfflineDepartureCompletedControlButtonsState();
}

class _OfflineDepartureCompletedControlButtonsState extends State<OfflineDepartureCompletedControlButtons> {
