...
import '../../../offline_states/calendar/offline_field_calendar_state.dart';
...
class DepartureCompletedSelectedDateBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final selected = context.watch<OfflineFieldCalendarState>().selectedDate;
              ...
              child: TextButton(
                onPressed: isToday
                    ...
                    : () {
                        ...
                        context.read<OfflineFieldCalendarState>().selectDate(todayYmd);
                      },
