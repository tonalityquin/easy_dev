...
class OfflineDepartureCompletedPageMergeLog extends StatefulWidget {
  ...
  @override
  State<OfflineDepartureCompletedPageMergeLog> createState() => _OfflineDepartureCompletedPageMergeLogState();
}

class _OfflineDepartureCompletedPageMergeLogState extends State<OfflineDepartureCompletedPageMergeLog> {
  // 날짜 범위(기본: 최근 7일)
  ...
  void _openPlateImageDialog(String plateNumber) {
    showGeneralDialog(
      ...
      pageBuilder: (_, __, ___) => OfflineDepartureCompletedPlateImageDialog(plateNumber: plateNumber),
    );
  }
