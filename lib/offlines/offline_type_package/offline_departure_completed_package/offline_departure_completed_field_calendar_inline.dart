...
class _OfflineDepartureCompletedFieldCalendarInlineState extends State<OfflineDepartureCompletedFieldCalendarInline> {
  ...
  Future<Map<String, int>> _departuredCountByDay({
    ...
    final rows = await db.query(
      ...
      ''',
      whereArgs: [_kStatusDepartured, area, first.millisecondsSinceEpoch, last.millisecondsSinceEpoch],
    );
