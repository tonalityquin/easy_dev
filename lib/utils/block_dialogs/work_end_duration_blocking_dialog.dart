...
Future<bool> showWorkEndDurationBlockingDialog(
  ...
  final result = await showDialog<bool>(
    ...
    builder: (_) => _WorkEndCancelableBlockingDialog(
      message: message,
      duration: duration,
    ),
  );
...
class _DialogTokens {
  ...
  factory _DialogTokens.of(BuildContext context) {
    ...
    return _DialogTokens(
      ...
      // ✅ work end도 primary(=독립 프리셋 highlight)로 통일 → KB 포함 일관
      accent: cs.primary,
...
class _WorkEndCancelableBlockingDialog extends StatefulWidget {
  const _WorkEndCancelableBlockingDialog({
  ...
  @override
  State<_WorkEndCancelableBlockingDialog> createState() => _WorkEndCancelableBlockingDialogState();
}

class _WorkEndCancelableBlockingDialogState extends State<_WorkEndCancelableBlockingDialog> {
  Timer? _timer;
