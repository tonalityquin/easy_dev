...
/// - '취소' 버튼 누르면 false 반환
Future<bool> showWorkStartDurationBlockingDialog(
  ...
  final result = await showDialog<bool>(
    ...
    builder: (_) => _WorkStartCancelableBlockingDialog(
      message: message,
      duration: duration,
    ),
  );
...
class _DialogTokens {
  ...
  /// ✅ 브랜드 하이라이트(독립 프리셋이면 highlightText)
  final Color accent;
...
class _WorkStartCancelableBlockingDialog extends StatefulWidget {
  const _WorkStartCancelableBlockingDialog({
  ...
  @override
  State<_WorkStartCancelableBlockingDialog> createState() => _WorkStartCancelableBlockingDialogState();
}

class _WorkStartCancelableBlockingDialogState extends State<_WorkStartCancelableBlockingDialog> {
  Timer? _timer;
      ...
      child: ConstrainedBox(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              // ✅ 상단 아이콘 + 로딩 링 (브랜드 accent = cs.primary)
              Stack(
