...
class ParkingRequestControlButtons extends StatelessWidget {
  ...
  Future<void> _handleBillingAction(
    ...
    final bool isZeroAutoLock = (((selectedPlate.basicAmount ?? 0) == 0) && ((selectedPlate.addAmount ?? 0) == 0)) ||
    ...
    try {
      ...
      final log = {
        ...
        'paymentMethod': result.paymentMethod,
        if (result.reason != null && result.reason!.trim().isNotEmpty) 'reason': result.reason!.trim(), // 사유 저장
      };
