...
class WorkingChatPanel extends StatefulWidget {
  /// 영역 전환 감지/쇼트컷 키 구분용 (시트 내부 roomId는 사용하지 않음)
  final String scopeKey;

  const WorkingChatPanel({super.key, required this.scopeKey});

  @override
  State<WorkingChatPanel> createState() => _WorkingChatPanelState();
}

class _WorkingChatPanelState extends State<WorkingChatPanel> {
  ...
  @override
  void didUpdateWidget(covariant WorkingChatPanel oldWidget) {
