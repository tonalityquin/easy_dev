...
import 'working_chat_panel.dart';

/// ─────────────────────────────────────────────────────────────
/// ✅ Working: 말풍선 팝오버(키보드 대응 + 화면 밖 침범 방지)
...
Future<void> _showChatPopoverWorking({
  ...
  try {
    await showGeneralDialog<void>(
      ...
      barrierLabel: 'chat_popover_working',
                  ...
                  children: [
                    Positioned(
                      ...
                      child: GestureDetector(
                        ...
                        onTap: () {},
                        child: _ChatPopoverShellWorking(
                          width: width,
                          height: height,
                          scopeKey: scopeKey,
...
class _ChatPopoverShellWorking extends StatelessWidget {
  const _ChatPopoverShellWorking({
    required this.width,
        ...
        children: [
          ...
          Expanded(
            child: Padding(
              ...
              child: WorkingChatPanel(scopeKey: scopeKey),
            ),
          ),
        ],
      ),
...
/// ✅ Working: 채팅 열기 버튼
/// - 변경 포인트: 버튼
/// 이 화면에 존재하는 동안 "알림 감시용 acquire(저빈도 폴링)" 1개 유지
/// ─────────────────────────────────────────────────────────────

class ChatOpenButtonWorking extends StatefulWidget {
  const ChatOpenButtonWorking({super.key});

  @override
  State<ChatOpenButtonWorking> createState() => _ChatOpenButtonWorkingState();
}

class _ChatOpenButtonWorkingState extends State<ChatOpenButtonWorking> {
