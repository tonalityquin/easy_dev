...
import '../../../features/dashboard/widgets/common/calendar_dialog/calendar_dialog.dart';
import '../../../features/dashboard/widgets/common/my_info_dialog/my_info_dialog.dart';
import '../../../features/dashboard/widgets/common/todo_dialog/todo_dialog.dart';
...
import 'parking_grid_3d_view_picker_dialog.dart';
...
Map<String, TextParkingPreviewMetrics> buildTextParkingPreviewMetricsByLocations({
...
String _previewSubtitleForLocation(LocationModel l, _PreviewEntryKind kind) {
  ...
  final parent = _locationLooseText(l, ['parentDisplayName', 'parentName', 'parent']);
...
class ParkingGrid3DPreviewCard extends StatefulWidget {
  ...
  @override
  State<ParkingGrid3DPreviewCard> createState() =>
      _ParkingGrid3DPreviewCardState();
}

class _ParkingGrid3DPreviewCardState extends State<ParkingGrid3DPreviewCard> {
  int _index = 0;
  int _navDir = 0;
  ...
  @override
  void didUpdateWidget(covariant ParkingGrid3DPreviewCard oldWidget) {
  ...
  Future<void> _openPicker(List<_PreviewEntry> entries) async {
    ...
    final picked = await showParkingGrid3DViewPickerDialog(
      context: context,
      title: '주차 구역 선택',
      items: items,
