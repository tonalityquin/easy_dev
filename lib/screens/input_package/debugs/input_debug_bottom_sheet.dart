...
class InputDebugBottomSheet extends StatefulWidget {
  const InputDebugBottomSheet({super.key});

  @override
  State<InputDebugBottomSheet> createState() => _InputDebugBottomSheetState();
}

class _InputDebugBottomSheetState extends State<InputDebugBottomSheet> {
  ...
  Future<void> _loadLog() async {
    final text = await InputDebugFirestoreLogger().readLog();
    setState(() {
      _isLoading = false;
      if (text.isEmpty) {
