...
class InputDebugFirestoreLogger {
  // 싱글턴 인스턴스
  static final InputDebugFirestoreLogger _instance = InputDebugFirestoreLogger._internal();
  factory InputDebugFirestoreLogger() => _instance;

  InputDebugFirestoreLogger._internal();
