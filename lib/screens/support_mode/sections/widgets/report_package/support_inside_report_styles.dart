...
class SupportReportButtonStyles {
  static const double _radius = 8.0;

  /// 메인 액션 버튼
  static ButtonStyle primary({double minHeight = 55}) {
    return ElevatedButton.styleFrom(
      backgroundColor: SupportReportColors.base,
      foregroundColor: SupportReportColors.fg,
      ...
      overlayColor: MaterialStateProperty.resolveWith<Color?>(
        (states) => states.contains(MaterialState.pressed) ? SupportReportColors.dark.withOpacity(.10) : null,
      ),
    );
  }
  ...
  static ButtonStyle outlined({double minHeight = 55}) {
    return OutlinedButton.styleFrom(
      foregroundColor: SupportReportColors.dark,
      backgroundColor: Colors.white,
      side: const BorderSide(
        color: SupportReportColors.light,
        width: 1.0,
      ),
      minimumSize: Size(0, minHeight),
      shape: RoundedRectangleBorder(
      ...
      overlayColor: MaterialStateProperty.resolveWith<Color?>(
        (states) => states.contains(MaterialState.pressed) ? SupportReportColors.light.withOpacity(.16) : null,
      ),
    );
  }
