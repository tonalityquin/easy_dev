...
class DoubleParkingReminderContents {
  ...
  const DoubleParkingReminderContents({
    required this.title,
    required this.lines,
  });
}

const List<DoubleParkingReminderContents> kDefaultParkingReminderContents = [
  DoubleParkingReminderContents(
    title: 'Test Title',
    lines: [
      '• Test line 1',
      '• Test line 2',
...
final Map<String, List<DoubleParkingReminderContents>> kParkingReminderContentsByArea = {
  '가로수길(캔버스랩)': [
    const DoubleParkingReminderContents(
      title: '업무 시작 전',
      lines: [
