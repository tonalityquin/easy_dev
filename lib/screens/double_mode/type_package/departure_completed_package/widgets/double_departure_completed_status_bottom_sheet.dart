...
Future<PlateModel?> showDoubleDepartureCompletedStatusBottomSheet({
  ...
  return showModalBottomSheet<PlateModel?>(
    ...
    builder: (_) => FractionallySizedBox(
      heightFactor: 1,
      child: _DoubleDepartureCompletedFullHeightSheet(
...
class _DoubleDepartureCompletedFullHeightSheet extends StatelessWidget {
  const _DoubleDepartureCompletedFullHeightSheet({
