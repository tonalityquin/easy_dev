...
void _traceDoublePunch(BuildContext context, AttBrkModeType type, DateTime dateTime) {
  ...
  DebugActionRecorder.instance.recordAction(
    ...
    meta: <String, dynamic>{
      'screen': 'double_dashboard_punch_card_feedback',
...
Future<void> showDoubleDashboardPunchCardFeedback(
    BuildContext context, {
      required AttBrkModeType type,
      required DateTime dateTime,
    }) async {
  _traceDoublePunch(context, type, dateTime);
...
class _PunchCardSheetState extends State<_PunchCardSheet> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    final cs = Theme.of(context).colorScheme;
    final accentColor = _accentColorForType(cs, widget.type);
...
class _PunchStatusCell extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final inactiveIconColor = cs.outline.withOpacity(0.65);
    final inactiveTextColor = cs.onSurfaceVariant;
        ...
        child: Column(
          ...
          children: [
            Icon(
              ...
              size: 16,
              color: showCheck ? accentColor.withOpacity(0.95) : inactiveIconColor,
            ),
            const SizedBox(height: 2),
            Text(
              showCheck ? label : '',
              ...
              style: textTheme.labelSmall?.copyWith(
                fontSize: 10,
                fontWeight: FontWeight.w700,
                color: showCheck ? cs.onSurface : inactiveTextColor,
              ),
            ),
          ],
        ),
