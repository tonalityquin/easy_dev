...
class DoubleDashboardInsidePunchRecorderSection extends StatefulWidget {
  ...
  @override
  State<DoubleDashboardInsidePunchRecorderSection> createState() =>
      _DoubleDashboardInsidePunchRecorderSectionState();
}

class _DoubleDashboardInsidePunchRecorderSectionState
    extends State<DoubleDashboardInsidePunchRecorderSection> {
  ...
  Future<void> _recordClockInAtToCommuteTrueFalse(DateTime clockInAt) async {
    ...
    if (!enabled) {
      debugPrint('[DashboardInsidePunchRecorder] commute_true_false OFF → 업데이트 스킵');
      return;
    }
                      ...
                      children: [
                        Expanded(
                          child: _PunchSlot(
                            ...
                            accentColor: _accentForType(cs, AttBrkModeType.workIn),
                        ...
                        Expanded(
                          child: _PunchSlot(
                            ...
                            accentColor: _accentForType(cs, AttBrkModeType.breakTime),
                        ...
                        Expanded(
                          child: _PunchSlot(
                            ...
                            accentColor: _accentForType(cs, AttBrkModeType.workOut),
...
class _PunchSlot extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final borderColor = punched
        ...
        : cs.outlineVariant.withOpacity(enabled ? .9 : .45);

    final bgColor = punched ? accentColor.withOpacity(0.07) : cs.surface;
        ...
        children: [
          Row(
            ...
            children: [
              Icon(
                _icon,
                size: 14,
                color: enabled ? accentColor.withOpacity(0.95) : cs.onSurfaceVariant.withOpacity(0.35),
              ),
              const SizedBox(width: 4),
              Text(
                label,
          ...
          Icon(
            ...
            color: punched
                ...
                : cs.outline.withOpacity(enabled ? .85 : .45),
          ),
