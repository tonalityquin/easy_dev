...
class _DoubleHqDashBoardPageState extends State<DoubleHqDashBoardPage> {
  ...
  late final DoubleHomeDashBoardController _controller = DoubleHomeDashBoardController();
              ...
              children: [
                ...
                AnimatedCrossFade(
                  ...
                  secondChild: Column(
                    crossAxisAlignment: CrossAxisAlignment.stretch,
                    children: [
                      DoubleHomeBreakButtonWidget(controller: _controller),
                      const SizedBox(height: 16),
...
/// ✅ 테마 설정 버튼 스타일: primary를 border/overlay로만 사용(배경은 surface 유지)
ButtonStyle _themePresetBtnStyle(BuildContext context) {
  final cs = Theme.of(context).colorScheme;
