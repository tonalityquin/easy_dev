class DoubleParkingCompletedRecord {
  final int? id;
  ...
  const DoubleParkingCompletedRecord({
    this.id,
  ...
  factory DoubleParkingCompletedRecord.fromMap(Map<String, Object?> map) {
    return DoubleParkingCompletedRecord(
      id: map['id'] as int?,
