...
class DoubleModifyCameraPreviewDialog extends StatefulWidget {
  final void Function(List<XFile>)? onCaptureComplete;
  final void Function(XFile)? onImageCaptured;

  const DoubleModifyCameraPreviewDialog({
    super.key,
  ...
  @override
  State<DoubleModifyCameraPreviewDialog> createState() =>
      _DoubleModifyCameraPreviewDialogState();
}

class _DoubleModifyCameraPreviewDialogState
    extends State<DoubleModifyCameraPreviewDialog> {
  late final DoubleModifyCameraHelper _cameraHelper;
                ...
                if (_capturedImages.isNotEmpty)
                  OutlinedButton.icon(
                    ...
                    style: OutlinedButton.styleFrom(
                      foregroundColor: cs.surface, // scrim 위에서 흰 톤
