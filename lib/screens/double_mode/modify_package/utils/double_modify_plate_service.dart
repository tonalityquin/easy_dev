...
class DoubleModifyPlateService {
    ...
    for (int i = 0; i < capturedImages.length; i++) {
      ...
      if (!file.existsSync()) {
        ...
        await _logApiError(
          ...
          tags: const <String>[_tPlate, _tPlateDouble, _tPlateModify, _tPlateUpload],
        );
        continue;
      }
      ...
      for (int attempt = 0; attempt < _uploadMaxAttempts; attempt++) {
        try {
          ...
          await _logApiError(
            ...
            tags: const <String>[_tPlate, _tPlateDouble, _tPlateModify, _tPlateUpload, _tGcs],
          );
        } catch (e) {
          await _logApiError(
            tag: 'DoubleModifyPlateService.uploadAndMergeImages',
  ...
  Future<bool> updatePlateInfo({
    ...
    try {
      ...
      await _logApiError(
        ...
        tags: const <String>[_tPlate, _tPlateDouble, _tPlateModify, _tPlateRepo],
      );
      rethrow;
    }
  }
