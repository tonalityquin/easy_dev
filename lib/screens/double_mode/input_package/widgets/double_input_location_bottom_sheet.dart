...
class DoubleInputLocationBottomSheet extends StatefulWidget {
  final TextEditingController locationController;
  final Function(String) onLocationSelected;

  const DoubleInputLocationBottomSheet({
    super.key,
  ...
  @override
  State<DoubleInputLocationBottomSheet> createState() => _DoubleInputLocationBottomSheetState();
}

class _DoubleInputLocationBottomSheetState extends State<DoubleInputLocationBottomSheet> {
