...
class DoubleLiveOcrPage extends StatefulWidget {
  const DoubleLiveOcrPage({super.key});

  @override
  State<DoubleLiveOcrPage> createState() => _DoubleLiveOcrPageState();
}

class _DoubleLiveOcrPageState extends State<DoubleLiveOcrPage> {
              ...
              child: Column(
                ...
                children: [
                  if (_debugText != null)
                    Text(
                      _debugText!,
                      style: TextStyle(color: cs.surface.withOpacity(0.85), fontSize: 12),
                    ),
                  if (_lastText != null && _lastText!.isNotEmpty)
                    Padding(
                      ...
                      child: Text(
                        ...
                        style: TextStyle(color: cs.surface.withOpacity(0.70), fontSize: 12),
                      ),
                    ),
                ],
              ),
