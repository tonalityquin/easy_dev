...
class DoubleInputPlateController {
  ...
  Future<void> doubleSubmitPlateEntry(
    ...
    try {
      final uploadedUrls = await DoubleInputPlateService.uploadCapturedImages(
        capturedImages,
        plateNumber,
        area,
        userName,
      ...
      final wasSuccessful = await DoubleInputPlateService.doubleRegisterPlateEntry(
        context: context,
        plateNumber: plateNumber,
        location: location,
