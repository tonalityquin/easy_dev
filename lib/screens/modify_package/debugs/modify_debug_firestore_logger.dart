...
class ModifyDebugFirestoreLogger {
  // 싱글턴 인스턴스
  static final ModifyDebugFirestoreLogger _instance = ModifyDebugFirestoreLogger._internal();
  factory ModifyDebugFirestoreLogger() => _instance;

  ModifyDebugFirestoreLogger._internal();
