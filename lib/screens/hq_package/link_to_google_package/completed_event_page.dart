...
import '../../../utils/snackbar_helper.dart'; // ✅ 커스텀 스낵바 헬퍼 추가(경로 조정)

class CompletedEventPage extends StatefulWidget {
  final String calendarId;

  const CompletedEventPage({super.key, required this.calendarId});

  @override
  State<CompletedEventPage> createState() => _CompletedEventPageState();
}

class _CompletedEventPageState extends State<CompletedEventPage> {
