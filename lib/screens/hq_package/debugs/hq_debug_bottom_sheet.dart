...
class HqDebugBottomSheet extends StatefulWidget {
  const HqDebugBottomSheet({super.key});

  @override
  State<HqDebugBottomSheet> createState() => _HqDebugBottomSheetState();
}

class _HqDebugBottomSheetState extends State<HqDebugBottomSheet> {
  ...
  Future<void> _loadLog() async {
    final text = await HqDebugFirestoreLogger().readLog();
    setState(() {
      _isLoading = false;
      if (text.isEmpty) {
