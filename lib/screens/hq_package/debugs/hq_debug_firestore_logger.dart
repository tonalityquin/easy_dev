...
class HqDebugFirestoreLogger {
  // 싱글턴 인스턴스
  static final HqDebugFirestoreLogger _instance = HqDebugFirestoreLogger._internal();
  factory HqDebugFirestoreLogger() => _instance;

  HqDebugFirestoreLogger._internal();
