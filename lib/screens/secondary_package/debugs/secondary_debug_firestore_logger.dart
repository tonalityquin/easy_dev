...
class SecondaryDebugFirestoreLogger {
  // 싱글턴 인스턴스
  static final SecondaryDebugFirestoreLogger _instance = SecondaryDebugFirestoreLogger._internal();
  factory SecondaryDebugFirestoreLogger() => _instance;

  SecondaryDebugFirestoreLogger._internal();
