...
import 'commute_inside_report_styles.dart';
import 'commute_inside_report_signature_dialog.dart';

class CommuteInsideReportFormPage extends StatefulWidget {
  const CommuteInsideReportFormPage({super.key});

  @override
  State<CommuteInsideReportFormPage> createState() =>
      _CommuteInsideReportFormPageState();
}

class _CommuteInsideReportFormPageState
    extends State<CommuteInsideReportFormPage> {
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      final filename =
      _safeFileName('업무시작보고서_${nameForFile}_${_dateTag(now)}');
    ...
    return InputDecoration(
      ...
      focusedBorder: OutlineInputBorder(
        ...
        borderSide: const BorderSide(
          color: CommuteReportColors.base,
          width: 1.6,
        ),
      ),
            ...
            Expanded(
              child: ElevatedButton(
                ...
                style: _hasSpecialNote == false
                    ? CommuteReportButtonStyles.primary()
                    : CommuteReportButtonStyles.outlined(),
          ...
          child: Wrap(
            ...
            children: [
              ...
              ElevatedButton.icon(
                ...
                style: CommuteReportButtonStyles.smallPrimary(),
              ),
              if (_signaturePngBytes != null)
                OutlinedButton.icon(
                  ...
                  style: CommuteReportButtonStyles.smallOutlined(),
                ),
            ],
          ),
        ),
              ...
              children: [
                ...
                Container(
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(
                      color:
                      CommuteReportColors.light.withOpacity(0.8),
                      width: 1,
                    ),
                  ),
                  padding:
                        ...
                        children: [
                          Expanded(
                            child: OutlinedButton.icon(
                              ...
                              style: CommuteReportButtonStyles
                                  .outlined(),
                            ),
                          ),
                          const SizedBox(width: 12),
