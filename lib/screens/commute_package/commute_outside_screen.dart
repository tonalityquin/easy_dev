...
import 'commute_outside_package/commute_outside_controller.dart';
import 'commute_outside_package/sections/commute_outside_report_button_section.dart';
import 'commute_outside_package/sections/commute_outside_work_button_section.dart';
import 'commute_outside_package/sections/commute_outside_user_info_card_section.dart';
import 'commute_outside_package/sections/commute_outside_header_widget_section.dart';
                ...
                SingleChildScrollView(
                  child: Center(
                    child: Padding(
                      ...
                      child: Column(
                        children: [
                          const CommuteOutsideHeaderWidgetSection(),
                          const CommuteOutsideUserInfoCardSection(),
                          const SizedBox(height: 6),
                          Row(
                            children: [
                              Expanded(
                                child: CommuteOutsideReportButtonSection(
                              ...
                              Expanded(
                                child: CommuteOutsideWorkButtonSection(
                                  controller: controller,
