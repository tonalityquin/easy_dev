...
import 'departure_completed_field_calendar_inline.dart';
...
class _DepartureCompletedUnsettledTabState extends State<DepartureCompletedUnsettledTab> {
  ...
  @override
  void didUpdateWidget(covariant DepartureCompletedUnsettledTab oldWidget) {
                ...
                child: PlateContainer(
                  ...
                  onPlateTap: (plateNumber, area) async {
                    ...
                    if (currentSelected != null &&
                      ...
                      final PlateModel? updated = await showDepartureCompletedStatusBottomSheet(
                        context: context,
