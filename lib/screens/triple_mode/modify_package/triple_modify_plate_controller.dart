...
class TripleModifyPlateController {
  ...
  Future<void> handleAction(
    ...
    final service = TripleModifyPlateService(
      context: context,
    ...
    if (success) {
      ...
      await plateState.tripleUpdatePlateLocally(collectionKey, updatedPlate);
