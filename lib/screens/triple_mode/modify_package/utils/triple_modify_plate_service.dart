...
class TripleModifyPlateService {
  ...
  Future<List<String>> uploadAndMergeImages(String plateNumber) async {
    ...
    for (int i = 0; i < capturedImages.length; i++) {
      ...
      if (!file.existsSync()) {
        ...
        await _logApiError(
          tag: 'TripleModifyPlateService.uploadAndMergeImages',
          ...
          tags: const <String>[_tPlate, _tPlateTriple, _tPlateModify, _tPlateUpload],
        );
        continue;
      }
      ...
      for (int attempt = 0; attempt < _uploadMaxAttempts; attempt++) {
        try {
          ...
          await _logApiError(
            ...
            tags: const <String>[_tPlate, _tPlateTriple, _tPlateModify, _tPlateUpload, _tGcs],
          );
        } catch (e) {
          await _logApiError(
            tag: 'TripleModifyPlateService.uploadAndMergeImages',
  ...
  Future<bool> updatePlateInfo({
    ...
    try {
      ...
      await _logApiError(
        tag: 'TripleModifyPlateService.updatePlateInfo',
        ...
        tags: const <String>[_tPlate, _tPlateTriple, _tPlateModify, _tPlateRepo],
      );
      rethrow;
    }
  }
  ...
  static Future<gcs.StorageApi> _storage() async {
    try {
      ...
      await _logApiError(
        tag: 'TripleModifyPlateService._storage',
  ...
  static Future<List<String>> listPlateImages({
    ...
    try {
      ...
      await _logApiError(
        tag: 'TripleModifyPlateService.listPlateImages',
