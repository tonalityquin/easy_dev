...
import 'utils/triple_commute_in_clock_in_save.dart';
...
class TripleCommuteInController {
  ...
  Future<CommuteDestination> _decideDestination(BuildContext context, UserState userState) async {
  ...
  Future<CommuteDestination> handleWorkStatusAndDecide(BuildContext context, UserState userState) async {
    try {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      switch (dest) {
        case CommuteDestination.headquarter:
          Navigator.pushReplacementNamed(context, AppRoutes.tripleHeadquarterPage);
          break;
        case CommuteDestination.type:
          Navigator.pushReplacementNamed(context, AppRoutes.tripleTypePage);
          break;
  ...
  Future<dynamic> _uploadAttendanceSilently(BuildContext context) async {
    ...
    final result = await TripleCommuteInClockInSave.uploadAttendanceJson(
      context: context,
      data: {
