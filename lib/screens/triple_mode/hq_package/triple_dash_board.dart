...
import '../type_package/common_widgets/dashboard_bottom_sheet/triple_hq_dash_board_page.dart';

class TripleDashBoard extends StatelessWidget {
  const TripleDashBoard({super.key});

  static const String screenTag = 'TripleHeadQuarter'; // 화면 식별 태그
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        body: const TripleHqDashBoardPage(), // 단일 콘텐츠
      ),
    );
  }
}
