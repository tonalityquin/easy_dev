...
class TripleMergedLogSection extends StatefulWidget {
  final List<Map<String, dynamic>> mergedLogs;
  final String division;
  final String area;

  const TripleMergedLogSection({
    super.key,
  ...
  @override
  State<TripleMergedLogSection> createState() => _TripleMergedLogSectionState();
}

class _TripleMergedLogSectionState extends State<TripleMergedLogSection> {
  ...
  void _openPlateImageDialog(String plateNumber) {
    try {
      ...
      _logApiError(
        tag: '_TripleMergedLogSectionState._openPlateImageDialog',
  ...
  Future<void> _load() async {
    ...
    try {
      ...
      await _logApiError(
        tag: '_TripleMergedLogSectionState._load',
  ...
  Future<void> _search() async {
    ...
    try {
      ...
      await _logApiError(
        tag: '_TripleMergedLogSectionState._search',
        message: '검색 처리 실패',
        error: e,
  ...
  Widget _infoChip(BuildContext context, String label, String value) {
    ...
    return Container(
      ...
      child: Text(
        '$label: $value',
        style: TextStyle(
            fontSize: 12, color: cs.onSurface, fontWeight: FontWeight.w700),
        maxLines: 1,
              ...
              child: IconButton(
                ...
                onPressed: () {
                  ...
                  try {
                    ...
                    _logApiError(
                      tag: '_TripleMergedLogSectionState.build.togglePage',
              ...
              : (_selectedHit == null
                  ? ListView.separated(
                      ...
                      separatorBuilder: (_, __) =>
                          Divider(height: 1, color: _Brand.divider(cs)),
                      itemBuilder: (_, i) {
                        final h = _hits[i];
