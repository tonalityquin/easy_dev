...
class TripleDepartureCompletedSearchBottomSheet extends StatefulWidget {
  ...
  const TripleDepartureCompletedSearchBottomSheet({
    super.key,
  ...
  @override
  State<TripleDepartureCompletedSearchBottomSheet> createState() => _TripleDepartureCompletedSearchBottomSheetState();
}
...
class _TripleDepartureCompletedSearchBottomSheetState extends State<TripleDepartureCompletedSearchBottomSheet>
                  ...
                  child: Column(
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          children: [
                            const Expanded(child: TripleDepartureCompletedPlateSearchHeader()),
                            IconButton(
                              tooltip: '닫기',
                      ...
                      Padding(
                        ...
                        child: ValueListenableBuilder<TextEditingValue>(
                          ...
                          builder: (context, value, child) {
                            ...
                            return TripleDepartureCompletedSearchButton(
                              isValid: valid,
  ...
  Widget _buildResultSection(BuildContext rootContext) {
    ...
    return TripleDepartureCompletedPlateSearchResults(
      results: _results,
      onSelect: (selected) {
