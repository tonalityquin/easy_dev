...
class TripleDepartureCompletedBottomSheet extends StatefulWidget {
  ...
  @override
  State<TripleDepartureCompletedBottomSheet> createState() => _TripleDepartureCompletedBottomSheetState();
}

class _TripleDepartureCompletedBottomSheetState extends State<TripleDepartureCompletedBottomSheet> {
  ...
  Widget build(BuildContext context) {
    ...
    final selectedPlate = plateState.tripleGetSelectedPlate(PlateType.departureCompleted, userName);
