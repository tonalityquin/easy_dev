class TripleParkingCompletedRecord {
  final int? id;
  ...
  const TripleParkingCompletedRecord({
    this.id,
  ...
  factory TripleParkingCompletedRecord.fromMap(Map<String, Object?> map) {
    return TripleParkingCompletedRecord(
      id: map['id'] as int?,
