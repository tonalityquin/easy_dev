...
class TripleParkingReminderContents {
  final String title;
  final List<String> lines;

  const TripleParkingReminderContents({
    required this.title,
    required this.lines,
  });
}

const List<TripleParkingReminderContents> kDefaultParkingReminderContents = [
  TripleParkingReminderContents(
    title: 'Test Title',
    lines: [
      '• Test line 1',
      '• Test line 2',
...
final Map<String, List<TripleParkingReminderContents>> kParkingReminderContentsByArea = {
  '가로수길(캔버스랩)': [
    const TripleParkingReminderContents(
      title: '업무 시작 전',
      lines: [
...
List<TripleParkingReminderContents> parkingRemindersForArea(String area) {
  final key = area.trim();
...
const List<TripleParkingReminderContents> kParkingReminderContents = kDefaultParkingReminderContents;
