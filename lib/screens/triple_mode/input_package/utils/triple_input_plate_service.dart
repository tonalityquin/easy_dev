...
class TripleInputPlateService {
  // ─────────────────────────────────────────
  // ✅ API 디버그 로직: 표준 태그 / 로깅 헬퍼
  // ─────────────────────────────────────────
  static const String _tPlate = 'plate';
  static const String _tPlateTriple = 'plate/Triple';
  ...
  static Future<List<String>> uploadCapturedImages(
    ...
    for (int i = 0; i < images.length; i++) {
      ...
      if (!file.existsSync()) {
        ...
        await _logApiError(
          tag: 'TripleInputPlateService.uploadCapturedImages',
          ...
          tags: const <String>[_tPlate, _tPlateTriple, _tPlateUpload],
        );
      ...
      for (int attempt = 0; attempt < _uploadMaxAttempts; attempt++) {
        try {
          ...
          await _logApiError(
            ...
            tags: const <String>[_tPlate, _tPlateTriple, _tPlateUpload, _tGcs],
          );
        } catch (e) {
  ...
  // ✅ 입차 등록: 예외 로깅 추가
  // ─────────────────────────────────────────
  static Future<bool> tripleRegisterPlateEntry({
    ...
    try {
      ...
      await _logApiError(
        tag: 'TripleInputPlateService.registerPlateEntry',
        ...
        tags: const <String>[_tPlate, _tPlateTriple, _tPlateRegister],
      );
      rethrow;
    }
  }
  ...
  static Future<gcs.StorageApi> _storage() async {
    try {
      ...
      await _logApiError(
        tag: 'TripleInputPlateService._storage',
  ...
  static Future<List<String>> listPlateImages({
    ...
    try {
      ...
      await _logApiError(
        tag: 'TripleInputPlateService.listPlateImages',
        ...
        tags: const <String>[_tPlate, _tPlateTriple, _tGcsList],
      );
      rethrow;
    }
    ...
    try {
      ...
      await _logApiError(
        ...
        tags: const <String>[_tPlate, _tPlateTriple, _tGcs, _tGcsList],
      );
      rethrow;
    }
  }
