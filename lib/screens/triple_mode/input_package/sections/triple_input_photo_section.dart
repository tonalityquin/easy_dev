...
import '../utils/triple_input_camera_fullscreen_viewer.dart';
import '../utils/triple_input_plate_service.dart';

class TripleInputPhotoSection extends StatelessWidget {
  final List<XFile> capturedImages;
  final String plateNumber;

  const TripleInputPhotoSection({
    super.key,
          ...
          child: capturedImages.isEmpty
            ...
            itemBuilder: (context, index) {
              ...
              return GestureDetector(
                onTap: () => tripleInputShowFullScreenImageViewer(
                  context,
                  capturedImages,
                  index,
                ),
