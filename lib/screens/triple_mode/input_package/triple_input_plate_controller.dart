...
import 'utils/triple_input_plate_service.dart';
...
class TripleInputPlateController {
  ...
  Future<void> tripleSubmitPlateEntry(
    ...
    try {
      final uploadedUrls = await TripleInputPlateService.uploadCapturedImages(
        capturedImages,
        plateNumber,
        area,
        userName,
      ...
      final wasSuccessful = await TripleInputPlateService.tripleRegisterPlateEntry(
        context: context,
        plateNumber: plateNumber,
        location: location,
