...
import '../utils/lite_input_camera_fullscreen_viewer.dart';
import '../utils/lite_input_plate_service.dart';

class LiteInputPhotoSection extends StatelessWidget {
  final List<XFile> capturedImages;
  final String plateNumber;

  const LiteInputPhotoSection({
    super.key,
          ...
          child: capturedImages.isEmpty
            ...
            itemBuilder: (context, index) {
              ...
              return GestureDetector(
                onTap: () => liteInputShowFullScreenImageViewer(
                  context,
                  capturedImages,
                  index,
                ),
              ...
              onPressed: () {
                showModalBottomSheet(
                  ...
                  builder: (_) {
                    ...
                    Future<List<String>> future = LiteInputPlateService.listPlateImages(
                      context: context,
                                                ...
                                                child: DropdownButton<String>(
                                                  ...
                                                  onChanged: (value) {
                                                    ...
                                                    setModalState(() {
                                                      ...
                                                      future = LiteInputPlateService.listPlateImages(
                                                        context: context,
                                                        plateNumber: plateNumber,
