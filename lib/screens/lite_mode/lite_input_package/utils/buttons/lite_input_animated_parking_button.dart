...
class LiteInputAnimatedParkingButton extends StatefulWidget {
  final bool isLocationSelected;
  final VoidCallback onPressed;
  final String? buttonLabel;

  const LiteInputAnimatedParkingButton({
    super.key,
  ...
  @override
  State<LiteInputAnimatedParkingButton> createState() => _LiteInputAnimatedParkingButtonState();
}

class _LiteInputAnimatedParkingButtonState extends State<LiteInputAnimatedParkingButton>
