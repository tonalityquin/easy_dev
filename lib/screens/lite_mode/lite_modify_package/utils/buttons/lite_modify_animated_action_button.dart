...
class LiteModifyAnimatedActionButton extends StatefulWidget {
  final bool isLoading;
  final bool isLocationSelected;
  final Future<void> Function() onPressed;
  final String? buttonLabel;

  const LiteModifyAnimatedActionButton({
    super.key,
  ...
  @override
  State<LiteModifyAnimatedActionButton> createState() => _LiteModifyAnimatedActionButtonState();
}

class _LiteModifyAnimatedActionButtonState extends State<LiteModifyAnimatedActionButton>
