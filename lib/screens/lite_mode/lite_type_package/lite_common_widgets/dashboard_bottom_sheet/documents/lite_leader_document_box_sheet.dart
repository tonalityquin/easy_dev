...
import 'lite_leader_document_inventory_repository.dart';
...
Future<void> openLeaderDocumentBox(BuildContext context) async {
  await showModalBottomSheet<void>(
    ...
    builder: (ctx) => const _LeaderDocumentBoxSheet(),
  );
}

class _LeaderDocumentBoxSheet extends StatelessWidget {
  const _LeaderDocumentBoxSheet();
