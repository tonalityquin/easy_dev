...
Future<PlateModel?> showLiteDepartureCompletedStatusBottomSheet({
  ...
  return showModalBottomSheet<PlateModel?>(
    ...
    builder: (_) => FractionallySizedBox(
      heightFactor: 1,
      child: _LiteDepartureCompletedFullHeightSheet(
...
class _LiteDepartureCompletedFullHeightSheet extends StatelessWidget {
  const _LiteDepartureCompletedFullHeightSheet({
