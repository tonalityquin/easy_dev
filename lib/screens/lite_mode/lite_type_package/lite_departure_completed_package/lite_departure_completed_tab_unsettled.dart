...
import 'departure_completed_plate_search_bottom_sheet/lite_departure_completed_search_bottom_sheet.dart';
...
class LiteDepartureCompletedUnsettledTab extends StatefulWidget {
  const LiteDepartureCompletedUnsettledTab({
    super.key,
    required this.firestorePlates, // 시그니처 호환(실제 렌더링은 LitePlateState 최신 데이터 사용)
...
class _LiteDepartureCompletedUnsettledTabState extends State<LiteDepartureCompletedUnsettledTab> {
  ...
  Future<void> _openPlateSearchBottomSheet() async {
    ...
    await showModalBottomSheet(
      ...
      builder: (_) => LiteDepartureCompletedSearchBottomSheet(
        area: area,
