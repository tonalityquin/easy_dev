...
const List<ReminderContent> kDefaultParkingReminderContents = [
  ReminderContent(
    title: 'Test Title',
    lines: [
      '• Test line 1',
...
final Map<String, List<ReminderContent>> kParkingReminderContentsByArea = {
  '가로수길(캔버스랩)': [
    const ReminderContent(
      title: '업무 시작 전',
      lines: [
...
List<ReminderContent> parkingRemindersForArea(String area) {
  final key = area.trim();
...
const List<ReminderContent> kParkingReminderContents = kDefaultParkingReminderContents;
