...
class ClockInDebugFirestoreLogger {
  // 싱글턴 인스턴스
  static final ClockInDebugFirestoreLogger _instance = ClockInDebugFirestoreLogger._internal();
  factory ClockInDebugFirestoreLogger() => _instance;

  ClockInDebugFirestoreLogger._internal();
