...
class ModifyDebugBottomSheet extends StatefulWidget {
  const ModifyDebugBottomSheet({super.key});

  @override
  State<ModifyDebugBottomSheet> createState() => _ModifyDebugBottomSheetState();
}

class _ModifyDebugBottomSheetState extends State<ModifyDebugBottomSheet> {
  ...
  Future<void> _loadLog() async {
    final text = await ModifyDebugFirestoreLogger().readLog();
    setState(() {
      _isLoading = false;
      if (text.isEmpty) {
