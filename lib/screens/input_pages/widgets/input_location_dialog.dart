...
class InputLocationDialog extends StatefulWidget {
  final TextEditingController locationController;
  final Function(String) onLocationSelected;

  const InputLocationDialog({
    super.key,
  ...
  @override
  State<InputLocationDialog> createState() => _InputLocationDialogState();
}

class _InputLocationDialogState extends State<InputLocationDialog> {
