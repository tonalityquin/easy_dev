...
import '../utils/monthly_camera_fullscreen_viewer.dart';
import '../monthly_plate_service.dart';

class MonthlyPhotoSection extends StatelessWidget {
  final List<XFile> capturedImages;
  final String plateNumber;

  const MonthlyPhotoSection({
    super.key,
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    child: FutureBuilder<List<String>>(
                                      future: MonthlyPlateService.listPlateImages(
                                        context: context,
