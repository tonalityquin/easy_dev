...
class MonthlyAnimatedParkingButton extends StatefulWidget {
  final bool isLocationSelected;
  final VoidCallback onPressed;
  final String? buttonLabel;

  const MonthlyAnimatedParkingButton({
    super.key,
  ...
  @override
  State<MonthlyAnimatedParkingButton> createState() => _MonthlyAnimatedParkingButtonState();
}

class _MonthlyAnimatedParkingButtonState extends State<MonthlyAnimatedParkingButton>
