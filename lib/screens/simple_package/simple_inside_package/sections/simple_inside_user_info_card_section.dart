...
class SimpleInsideUserInfoCardSection extends StatelessWidget {
  const SimpleInsideUserInfoCardSection({super.key});
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Divider(
                color: _Palette.light.withOpacity(.35),
                height: 1,
              ),
              ...
              _infoRow(
                Icons.phone,
                'Tel.',
                formatPhoneNumber(userState.phone),
              ),
              _infoRow(
                Icons.location_on,
                'Sector.',
