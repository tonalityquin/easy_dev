...
class TabletLoginDebugFirestoreLogger {
  // 싱글턴 인스턴스
  static final TabletLoginDebugFirestoreLogger _instance = TabletLoginDebugFirestoreLogger._internal();
  factory TabletLoginDebugFirestoreLogger() => _instance;

  TabletLoginDebugFirestoreLogger._internal();
