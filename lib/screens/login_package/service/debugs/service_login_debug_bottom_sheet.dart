...
class LoginDebugBottomSheet extends StatefulWidget {
  ...
  @override
  State<LoginDebugBottomSheet> createState() => _LoginDebugBottomSheetState();
}

class _LoginDebugBottomSheetState extends State<LoginDebugBottomSheet> {
  ...
  Future<void> _loadLog() async {
    final text = await LoginDebugFirestoreLogger().readLog();
    setState(() {
      _isLoading = false;
      if (text.isEmpty) {
  ...
  Future<void> _clearLog() async {
    ...
    if (!mounted) return; // ✅ State의 mounted 확인
  ...
  Future<void> _copyLogsToClipboard() async {
    ...
    if (!mounted) return; // State의 mounted 속성 사용
