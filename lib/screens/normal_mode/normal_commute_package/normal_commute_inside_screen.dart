...
import 'commute_inside_package/normal_commute_inside_controller.dart';
import 'commute_inside_package/sections/normal_commute_inside_work_button_section.dart';
import 'commute_inside_package/sections/normal_commute_inside_user_info_card_section.dart';
import 'commute_inside_package/sections/normal_commute_inside_header_widget_section.dart';

class NormalCommuteInsideScreen extends StatefulWidget {
  const NormalCommuteInsideScreen({super.key});

  @override
  State<NormalCommuteInsideScreen> createState() => _NormalCommuteInsideScreenState();
}

class _NormalCommuteInsideScreenState extends State<NormalCommuteInsideScreen> {
  final controller = NormalCommuteInsideController();
  String? kakaoUrl;
                  ...
                  SingleChildScrollView(
                    child: Center(
                      child: Padding(
                        ...
                        child: Column(
                          children: [
                            const NormalCommuteInsideHeaderWidgetSection(),
                            const NormalCommuteInsideUserInfoCardSection(),
                            const SizedBox(height: 12),

                            // 🔹 업무 보고 버튼 제거 → 근무 버튼만 전체 폭으로 배치
                            SizedBox(
                              width: double.infinity,
                              child: NormalCommuteInsideWorkButtonSection(
