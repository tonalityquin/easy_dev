...
class NormalCommuteInsideUserInfoCardSection extends StatelessWidget {
  const NormalCommuteInsideUserInfoCardSection({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    final base = palette.normalBase;   // 기존 _Palette.base
    final dark = palette.normalDark;   // 기존 _Palette.dark
    final light = palette.normalLight; // 기존 _Palette.light
