...
import '../normal_commute_inside_controller.dart';
import '../../../../../routes.dart';

class NormalCommuteInsideWorkButtonSection extends StatelessWidget {
  final NormalCommuteInsideController controller;
  final ValueChanged<bool> onLoadingChanged;

  const NormalCommuteInsideWorkButtonSection({
    super.key,
          ...
          switch (dest) {
            case CommuteDestination.headquarter:
              Navigator.pushReplacementNamed(
                context,
                AppRoutes.normalHeadquarterPage,
              );
              break;
            case CommuteDestination.type:
              Navigator.pushReplacementNamed(
                context,
                AppRoutes.normalTypePage,
              );
              break;
