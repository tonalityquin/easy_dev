...
import 'utils/normal_commute_inside_clock_in_log_uploader.dart';
...
class NormalCommuteInsideController {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      switch (dest) {
        case CommuteDestination.headquarter:
          Navigator.pushReplacementNamed(context, AppRoutes.normalHeadquarterPage);
          break;
        case CommuteDestination.type:
          Navigator.pushReplacementNamed(context, AppRoutes.normalTypePage);
          break;
  ...
  Future<dynamic> _uploadAttendanceSilently(BuildContext context) async {
    ...
    final result = await NormalCommuteInsideClockInLogUploader.uploadAttendanceJson(
      context: context,
      data: {
