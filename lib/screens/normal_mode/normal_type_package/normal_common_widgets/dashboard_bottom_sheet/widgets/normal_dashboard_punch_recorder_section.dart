...
import 'normal_dashboard_punch_card_feedback.dart';
...
class NormalDashboardInsidePunchRecorderSection extends StatefulWidget {
  const NormalDashboardInsidePunchRecorderSection({
    super.key,
  ...
  @override
  State<NormalDashboardInsidePunchRecorderSection> createState() =>
      _NormalDashboardInsidePunchRecorderSectionState();
}

class _NormalDashboardInsidePunchRecorderSectionState
    extends State<NormalDashboardInsidePunchRecorderSection> {
  ...
  Future<void> _punch(AttBrkModeType type) async {
    ...
    await showNormalDashboardPunchCardFeedback(
      context,
      type: type,
      dateTime: targetDateTime,
    );
