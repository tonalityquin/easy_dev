...
/// ✅ Normal 펀칭 이벤트를 Trace에 기록
/// - Trace 탭에서 "기록 시작" 상태일 때만 실제로 누적됨(recordAction 내부에서 _recording이 아니면 return)
void _traceNormalPunch(BuildContext context, SimpleModeAttendanceType type, DateTime dateTime) {
  final String name;
  switch (type) {
  ...
  DebugActionRecorder.instance.recordAction(
    ...
    meta: <String, dynamic>{
      'screen': 'normal_dashboard_punch_card_feedback',
...
Future<void> showNormalDashboardPunchCardFeedback(
    BuildContext context, {
      required SimpleModeAttendanceType type,
      required DateTime dateTime,
    }) async {
  // ✅ Trace 기록(휴게/퇴근 포함)
  _traceNormalPunch(context, type, dateTime);
