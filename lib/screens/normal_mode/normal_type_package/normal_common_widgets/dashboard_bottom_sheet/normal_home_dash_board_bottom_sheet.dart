...
import 'widgets/normal_dashboard_punch_recorder_section.dart';

// ✅ [추가] 사진 전송(공용) 페이지
import 'package:easydev/screens/common_package/camera_package/photo_transfer_mail_page.dart';

class NormalHomeDashBoardBottomSheet extends StatefulWidget {
  const NormalHomeDashBoardBottomSheet({super.key});

  @override
  State<NormalHomeDashBoardBottomSheet> createState() => _NormalHomeDashBoardBottomSheetState();
}

class _NormalHomeDashBoardBottomSheetState extends State<NormalHomeDashBoardBottomSheet> {
              ...
              return SingleChildScrollView(
                ...
                child: Column(
                  children: [
                    ...
                    NormalDashboardInsidePunchRecorderSection(
