...
class NormalDepartureCompletedFieldCalendarInline extends StatefulWidget {
  const NormalDepartureCompletedFieldCalendarInline({super.key});

  @override
  State<NormalDepartureCompletedFieldCalendarInline> createState() => _NormalDepartureCompletedFieldCalendarInlineState();
}

class _NormalDepartureCompletedFieldCalendarInlineState extends State<NormalDepartureCompletedFieldCalendarInline> {
  ...
  Widget build(BuildContext context) {
    ...
    final plateState = context.watch<NormalPlateState>();

    final allCompleted = plateState.normalGetPlatesByCollection(
