...
class NormalDepartureCompletedControlButtons extends StatelessWidget {
  final bool isSearchMode;
  final VoidCallback onResetSearch;
  final VoidCallback onShowSearchDialog;

  const NormalDepartureCompletedControlButtons({
    super.key,
        ...
        child: SizedBox(
          ...
          child: Center(
            child: isPlateSelected
                ? TextButton.icon(
              onPressed: () async {
                await showNormalDepartureCompletedStatusBottomSheet(
                  context: context,
