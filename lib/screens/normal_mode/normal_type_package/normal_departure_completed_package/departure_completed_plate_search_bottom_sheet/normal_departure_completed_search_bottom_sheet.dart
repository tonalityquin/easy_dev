...
import '../widgets/normal_departure_completed_status_bottom_sheet.dart';
import 'keypad/animated_keypad.dart';
import 'widgets/normal_departure_completed_plate_number_display.dart';
import 'widgets/normal_departure_completed_plate_search_header.dart';
import 'widgets/normal_departure_completed_plate_search_results.dart';
import 'widgets/normal_departure_completed_search_button.dart';
import '../../../../../../repositories/plate_repo_services/firestore_plate_repository.dart';

class NormalDepartureCompletedSearchBottomSheet extends StatefulWidget {
  final void Function(String) onSearch;
  final String area;

  const NormalDepartureCompletedSearchBottomSheet({
    super.key,
  ...
  @override
  State<NormalDepartureCompletedSearchBottomSheet> createState() => _NormalDepartureCompletedSearchBottomSheetState();
}

class _NormalDepartureCompletedSearchBottomSheetState extends State<NormalDepartureCompletedSearchBottomSheet>
                  ...
                  child: Column(
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          children: [
                            const Expanded(child: NormalDepartureCompletedPlateSearchHeader()),
                            IconButton(
                              tooltip: '닫기',
                        ...
                        child: ListView(
                          ...
                          children: [
                            ...
                            _CardSection(
                              ...
                              subtitle: '예: 1234',
                              accent: _base,
                              child: NormalDepartureCompletedPlateNumberDisplay(
                      ...
                      Padding(
                        ...
                        child: ValueListenableBuilder<TextEditingValue>(
                          ...
                          builder: (context, value, child) {
                            ...
                            return NormalDepartureCompletedSearchButton(
                              isValid: valid,
  ...
  Widget _buildResultSection(BuildContext rootContext, ScrollController scrollController) {
    ...
    return NormalDepartureCompletedPlateSearchResults(
      results: _results,
      onSelect: (selected) {
        ...
        WidgetsBinding.instance.addPostFrameCallback((_) {
          showNormalDepartureCompletedStatusBottomSheet(
            context: rootContext,
            plate: selected,
          );
        });
