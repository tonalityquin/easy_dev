...
Future<PlateModel?> showNormalDepartureCompletedStatusBottomSheet({
  ...
  return showModalBottomSheet<PlateModel?>(
    ...
    builder: (_) => FractionallySizedBox(
      heightFactor: 1,
      child: _NormalDepartureCompletedFullHeightSheet(
...
class _NormalDepartureCompletedFullHeightSheet extends StatelessWidget {
  const _NormalDepartureCompletedFullHeightSheet({
