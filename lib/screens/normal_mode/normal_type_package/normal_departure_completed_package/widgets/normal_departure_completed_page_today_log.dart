...
class NormalTodayLogSection extends StatefulWidget {
  const NormalTodayLogSection({
    super.key,
  ...
  @override
  State<NormalTodayLogSection> createState() => _NormalTodayLogSectionState();
}

class _NormalTodayLogSectionState extends State<NormalTodayLogSection> {
              ...
              ElevatedButton(
                onPressed: () {
                  showGeneralDialog(
                    ...
                    pageBuilder: (_, __, ___) => NormalDepartureCompletedPlateImageDialog(plateNumber: widget.plateNumber),
                  );
                },
