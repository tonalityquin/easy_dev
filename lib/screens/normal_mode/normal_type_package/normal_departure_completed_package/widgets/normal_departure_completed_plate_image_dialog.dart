...
import '../../../normal_modify_package/utils/normal_modify_plate_service.dart';

class NormalDepartureCompletedPlateImageDialog extends StatelessWidget {
  final String plateNumber;

  const NormalDepartureCompletedPlateImageDialog({super.key, required this.plateNumber});
