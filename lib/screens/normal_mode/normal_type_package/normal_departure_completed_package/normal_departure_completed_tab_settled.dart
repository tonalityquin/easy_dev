...
import '../normal_departure_completed_package/widgets/normal_departure_completed_page_merge_log.dart';
import '../normal_departure_completed_package/widgets/normal_departure_completed_page_today_log.dart';
import '../../../../utils/snackbar_helper.dart'; // ✅ 커스텀 스낵바 헬퍼 추가

class NormalDepartureCompletedSettledTab extends StatefulWidget {
  const NormalDepartureCompletedSettledTab({
    super.key,
    required this.area,
  ...
  @override
  State<NormalDepartureCompletedSettledTab> createState() => _NormalDepartureCompletedSettledTabState();
}

class _NormalDepartureCompletedSettledTabState extends State<NormalDepartureCompletedSettledTab> {
  // ===== 아코디언 상태: 최대 1개만 열림 =====
