...
class NormalParkingCompletedLocationPicker extends StatefulWidget {
  final Function(String locationName) onLocationSelected;
  final bool isLocked;

  const NormalParkingCompletedLocationPicker({
    super.key,
  ...
  @override
  State<NormalParkingCompletedLocationPicker> createState() =>
      _NormalParkingCompletedLocationPickerState();
}

class _NormalParkingCompletedLocationPickerState
    extends State<NormalParkingCompletedLocationPicker> {
