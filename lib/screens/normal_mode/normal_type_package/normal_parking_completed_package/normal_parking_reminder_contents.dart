...
class NormalParkingReminderContents {
  final String title;
  final List<String> lines;

  const NormalParkingReminderContents({
    required this.title,
    required this.lines,
  });
}

const List<NormalParkingReminderContents> kDefaultParkingReminderContents = [
  NormalParkingReminderContents(
    title: 'Test Title',
    lines: [
      '• Test line 1',
      '• Test line 2',
...
final Map<String, List<NormalParkingReminderContents>> kParkingReminderContentsByArea = {
  '가로수길(캔버스랩)': [
    const NormalParkingReminderContents(
      title: '업무 시작 전',
      lines: [
...
List<NormalParkingReminderContents> parkingRemindersForArea(String area) {
  final key = area.trim();
...
const List<NormalParkingReminderContents> kParkingReminderContents = kDefaultParkingReminderContents;
