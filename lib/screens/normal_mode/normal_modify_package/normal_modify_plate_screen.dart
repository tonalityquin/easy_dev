...
import 'normal_modify_plate_controller.dart';
import 'sections/normal_modify_location_section.dart';
import 'sections/normal_modify_photo_section.dart';
import 'sections/normal_modify_plate_section.dart';
import 'sections/normal_modify_status_custom_section.dart';

import 'utils/buttons/normal_modify_animated_action_button.dart';
import 'utils/buttons/normal_modify_animated_parking_button.dart';
import 'utils/buttons/normal_modify_animated_photo_button.dart';

import 'widgets/normal_modify_bottom_navigation.dart';
import 'widgets/normal_modify_camera_preview_dialog.dart';
import 'widgets/normal_modify_location_bottom_sheet.dart';
import '../../../utils/snackbar_helper.dart';
import 'utils/normal_modify_camera_helper.dart';

class NormalModifyPlateScreen extends StatefulWidget {
  final PlateModel plate;
  final PlateType collectionKey;

  const NormalModifyPlateScreen({
    super.key,
    required this.plate,
  ...
  @override
  State<NormalModifyPlateScreen> createState() => _NormalModifyPlateScreenState();
}

class _NormalModifyPlateScreenState extends State<NormalModifyPlateScreen> {
  // ⬇️ 화면 식별 태그(FAQ/에러 리포트 연계용)
  static const String screenTag = 'plate modify';

  late NormalModifyPlateController _controller;
  late NormalModifyCameraHelper _cameraHelper;
  ...
  void initState() {
    ...
    _controller = NormalModifyPlateController(
      context: context,
      plate: widget.plate,
    ...
    _cameraHelper = NormalModifyCameraHelper();
  ...
  void _showCameraPreviewDialog() async {
    ...
    await showDialog(
      context: context,
      builder: (context) => NormalModifyCameraPreviewDialog(
  ...
  void _selectParkingLocation() {
    showDialog(
      context: context,
      builder: (_) => NormalModifyLocationBottomSheet(
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      NormalModifyLocationSection(locationController: _controller.locationController),
                      const SizedBox(height: 32.0),
                      NormalModifyPhotoSection(
                      ...
                      child: ListView(
                        ...
                        children: [
                          ...
                          if (_controller.fetchedCustomStatus != null)
                            NormalModifyStatusCustomSection(
            ...
            actionButton: Column(
              ...
              children: [
                Row(
                  children: [
                    Expanded(
                      child: NormalModifyAnimatedPhotoButton(onPressed: _showCameraPreviewDialog),
                    ),
                    const SizedBox(width: 10),
                    Expanded(
                      child: NormalModifyAnimatedParkingButton(
                ...
                NormalModifyAnimatedActionButton(
                  isLoading: isLoading,
                  isLocationSelected: _controller.isLocationSelected,
                  buttonLabel: '수정 완료',
                  onPressed: () async {
