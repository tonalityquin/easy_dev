...
import '../utils/normal_modify_camera_fullscreen_viewer.dart';
import '../utils/normal_modify_plate_service.dart';

class NormalModifyPhotoSection extends StatelessWidget {
  final List<XFile> capturedImages;
  final List<String> imageUrls;
  final String plateNumber;

  const NormalModifyPhotoSection({
    super.key,
          ...
          child: totalItems.isEmpty
            ...
            itemBuilder: (context, index) {
              ...
              return GestureDetector(
                onTap: () => normalModifyshowFullScreenImageViewer(
                  context,
              ...
              onPressed: () {
                showModalBottomSheet(
                  ...
                  builder: (_) {
                    ...
                    Future<List<String>> future = NormalModifyPlateService.listPlateImages(
                      context: context,
                                                ...
                                                child: DropdownButton<String>(
                                                  ...
                                                  onChanged: (value) {
                                                    ...
                                                    setModalState(() {
                                                      ...
                                                      future = NormalModifyPlateService.listPlateImages(
                                                        context: context,
                                                        plateNumber: plateNumber,
