...
class NormalModifyStatusOnTapSection extends StatefulWidget {
  ...
  const NormalModifyStatusOnTapSection({
    super.key,
  ...
  @override
  State<NormalModifyStatusOnTapSection> createState() => _NormalModifyStatusOnTapSectionState();
}

class _NormalModifyStatusOnTapSectionState extends State<NormalModifyStatusOnTapSection> {
