...
class NormalModifyPlateService {
  ...
  static const String _tPlateNormal = 'plate/normal';
  ...
  Future<List<String>> uploadAndMergeImages(String plateNumber) async {
    ...
    for (int i = 0; i < capturedImages.length; i++) {
      ...
      if (!file.existsSync()) {
        ...
        await _logApiError(
          tag: 'NormalModifyPlateService.uploadAndMergeImages',
          ...
          tags: const <String>[_tPlate, _tPlateNormal, _tPlateModify, _tPlateUpload],
        );
        continue;
      }
      ...
      for (int attempt = 0; attempt < _uploadMaxAttempts; attempt++) {
        try {
          ...
          await _logApiError(
            ...
            tags: const <String>[_tPlate, _tPlateNormal, _tPlateModify, _tPlateUpload, _tGcs],
          );
        } catch (e) {
          await _logApiError(
            tag: 'NormalModifyPlateService.uploadAndMergeImages',
  ...
  Future<bool> updatePlateInfo({
    ...
    try {
      ...
      await _logApiError(
        tag: 'NormalModifyPlateService.updatePlateInfo',
        ...
        tags: const <String>[_tPlate, _tPlateNormal, _tPlateModify, _tPlateRepo],
      );
      rethrow;
    }
  }
  ...
  static Future<gcs.StorageApi> _storage() async {
    try {
      ...
      await _logApiError(
        tag: 'NormalModifyPlateService._storage',
  ...
  static Future<List<String>> listPlateImages({
    ...
    try {
      ...
      await _logApiError(
        tag: 'NormalModifyPlateService.listPlateImages',
        ...
        tags: const <String>[_tPlate, _tPlateNormal, _tGcsList],
      );
      rethrow;
    }
    ...
    try {
      ...
      await _logApiError(
        ...
        tags: const <String>[_tPlate, _tPlateNormal, _tGcs, _tGcsList],
      );
      rethrow;
    }
  }
