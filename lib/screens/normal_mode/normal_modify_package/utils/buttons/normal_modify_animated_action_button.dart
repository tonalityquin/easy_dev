...
class NormalModifyAnimatedActionButton extends StatefulWidget {
  final bool isLoading;
  final bool isLocationSelected;
  final Future<void> Function() onPressed;
  final String? buttonLabel;

  const NormalModifyAnimatedActionButton({
    super.key,
  ...
  @override
  State<NormalModifyAnimatedActionButton> createState() => _NormalModifyAnimatedActionButtonState();
}

class _NormalModifyAnimatedActionButtonState extends State<NormalModifyAnimatedActionButton>
