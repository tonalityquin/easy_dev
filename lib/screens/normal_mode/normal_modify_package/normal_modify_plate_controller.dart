...
class NormalModifyPlateController {
  ...
  Future<void> handleAction(
    ...
    final service = NormalModifyPlateService(
      context: context,
    ...
    if (success) {
      ...
      await normalPlateState.normalUpdatePlateLocally(collectionKey, updatedPlate);
