...
class NormalModifyCameraPreviewDialog extends StatefulWidget {
  final void Function(List<XFile>)? onCaptureComplete;
  final void Function(XFile)? onImageCaptured;

  const NormalModifyCameraPreviewDialog({
    super.key,
  ...
  @override
  State<NormalModifyCameraPreviewDialog> createState() =>
      _NormalModifyCameraPreviewDialogState();
}

class _NormalModifyCameraPreviewDialogState
    extends State<NormalModifyCameraPreviewDialog> {
  late final NormalModifyCameraHelper _cameraHelper;
