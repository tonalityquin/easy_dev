...
class NormalModifyLocationBottomSheet extends StatefulWidget {
  final TextEditingController locationController;
  final Function(String) onLocationSelected;

  const NormalModifyLocationBottomSheet({
    super.key,
  ...
  @override
  State<NormalModifyLocationBottomSheet> createState() => _NormalModifyLocationBottomSheetState();
}

class _NormalModifyLocationBottomSheetState extends State<NormalModifyLocationBottomSheet> {
