...
class NormalLiveOcrPage extends StatefulWidget {
  const NormalLiveOcrPage({super.key});

  @override
  State<NormalLiveOcrPage> createState() => _NormalLiveOcrPageState();
}

class _NormalLiveOcrPageState extends State<NormalLiveOcrPage> {
