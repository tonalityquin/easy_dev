...
class NormalInputPlateController {
  ...
  Future<void> normalSubmitPlateEntry(
    ...
    try {
      final uploadedUrls = await NormalInputPlateService.uploadCapturedImages(
        capturedImages,
        plateNumber,
        area,
        userName,
      ...
      final wasSuccessful = await NormalInputPlateService.normalRegisterPlateEntry(
        context: context,
        plateNumber: plateNumber,
        location: location,
