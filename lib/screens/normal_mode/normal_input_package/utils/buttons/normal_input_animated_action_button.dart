...
class NormalInputAnimatedActionButton extends StatefulWidget {
  final bool isLoading;
  final bool isLocationSelected;
  final Future<void> Function() onPressed;

  const NormalInputAnimatedActionButton({
    super.key,
  ...
  @override
  State<NormalInputAnimatedActionButton> createState() => _NormalInputAnimatedActionButtonState();
}

class _NormalInputAnimatedActionButtonState extends State<NormalInputAnimatedActionButton>
