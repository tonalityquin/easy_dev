...
import '../utils/normal_input_camera_fullscreen_viewer.dart';
import '../utils/normal_input_plate_service.dart';

class NormalInputPhotoSection extends StatelessWidget {
  final List<XFile> capturedImages;
  final String plateNumber;

  const NormalInputPhotoSection({
    super.key,
          ...
          child: capturedImages.isEmpty
            ...
            itemBuilder: (context, index) {
              ...
              return GestureDetector(
                onTap: () => normalInputShowFullScreenImageViewer(
                  context,
                  capturedImages,
                  index,
                ),
              ...
              onPressed: () {
                showModalBottomSheet(
                  ...
                  builder: (_) {
                    ...
                    Future<List<String>> future = NormalInputPlateService.listPlateImages(
                      context: context,
                                                ...
                                                child: DropdownButton<String>(
                                                  ...
                                                  onChanged: (value) {
                                                    ...
                                                    setModalState(() {
                                                      ...
                                                      future = NormalInputPlateService.listPlateImages(
                                                        context: context,
                                                        plateNumber: plateNumber,
