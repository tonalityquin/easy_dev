...
import '../utils/normal_input_plate_field.dart';
import '../widgets/normal_input_region_bottom_sheet.dart';

class NormalInputPlateSection extends StatelessWidget {
      ...
      children: [
        ...
        Row(
          ...
          children: [
            GestureDetector(
              onTap: () {
                normalInputRegionPickerBottomSheet(
                  context: context,
