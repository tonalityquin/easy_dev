...
Future<Map<String, dynamic>?> normalInputCustomStatusBottomSheet(
  ...
  try {
    ...
    debugPrint('[normalInputCustomStatusBottomSheet] FirebaseException: ${e.code} ${e.message}');
    docSnapshot = null;
  } catch (e) {
    debugPrint('[normalInputCustomStatusBottomSheet] error: $e');
    docSnapshot = null;
  } finally {
    await UsageReporter.instance.report(
      ...
      action: 'read',
      n: 1,
      source: 'normalInputCustomStatusBottomSheet/$collectionName.doc.get',
