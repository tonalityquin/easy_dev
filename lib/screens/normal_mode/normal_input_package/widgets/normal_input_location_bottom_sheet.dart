...
class NormalInputLocationBottomSheet extends StatefulWidget {
  final TextEditingController locationController;
  final Function(String) onLocationSelected;

  const NormalInputLocationBottomSheet({
    super.key,
  ...
  static Future<void> show(BuildContext context, TextEditingController controller, Function(String) onSelected) async {
    await showModalBottomSheet(
      ...
      builder: (_) {
        return NormalInputLocationBottomSheet(
  ...
  @override
  State<NormalInputLocationBottomSheet> createState() => _NormalInputLocationBottomSheetState();
}

class _NormalInputLocationBottomSheetState extends State<NormalInputLocationBottomSheet> {
