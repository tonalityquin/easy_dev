...
class NormalInputCameraPreviewDialog extends StatefulWidget {
  final void Function(List<XFile>)? onCaptureComplete;
  final void Function(XFile)? onImageCaptured;

  const NormalInputCameraPreviewDialog({
    super.key,
  ...
  @override
  State<NormalInputCameraPreviewDialog> createState() =>
      _NormalInputCameraPreviewDialogState();
}

class _NormalInputCameraPreviewDialogState extends State<NormalInputCameraPreviewDialog> {
