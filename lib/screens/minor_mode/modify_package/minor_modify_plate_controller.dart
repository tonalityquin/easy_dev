...
class MinorModifyPlateController {
  ...
  Future<void> handleAction(
    ...
    final service = MinorModifyPlateService(
      context: context,
    ...
    if (success) {
      ...
      await plateState.minorUpdatePlateLocally(collectionKey, updatedPlate);
