...
class MinorModifyCameraPreviewDialog extends StatefulWidget {
  final void Function(List<XFile>)? onCaptureComplete;
  final void Function(XFile)? onImageCaptured;

  const MinorModifyCameraPreviewDialog({
    super.key,
  ...
  @override
  State<MinorModifyCameraPreviewDialog> createState() =>
      _MinorModifyCameraPreviewDialogState();
}
