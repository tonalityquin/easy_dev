...
class MinorInputPlateService {
  ...
  static Future<List<String>> uploadCapturedImages(
    ...
    for (int i = 0; i < images.length; i++) {
      ...
      if (!file.existsSync()) {
        ...
        await _logApiError(
          tag: 'MinorInputPlateService.uploadCapturedImages',
          ...
          tags: const <String>[_tPlate, _tPlateMinor, _tPlateUpload],
        );
      ...
      for (int attempt = 0; attempt < _uploadMaxAttempts; attempt++) {
        try {
          ...
          await _logApiError(
            ...
            tags: const <String>[_tPlate, _tPlateMinor, _tPlateUpload, _tGcs],
          );
        } catch (e) {
  ...
  // ✅ 입차 등록: 예외 로깅 추가
  // ─────────────────────────────────────────
  static Future<bool> minorRegisterPlateEntry({
    ...
    try {
      ...
      await _logApiError(
        tag: 'MinorInputPlateService.registerPlateEntry',
        ...
        tags: const <String>[_tPlate, _tPlateMinor, _tPlateRegister],
      );
      rethrow;
    }
  }
  ...
  static Future<gcs.StorageApi> _storage() async {
    try {
      ...
      await _logApiError(
        tag: 'MinorInputPlateService._storage',
  ...
  static Future<List<String>> listPlateImages({
    ...
    try {
      ...
      await _logApiError(
        tag: 'MinorInputPlateService.listPlateImages',
