...
class MinorInputCameraPreviewDialog extends StatefulWidget {
  final void Function(List<XFile>)? onCaptureComplete;
  final void Function(XFile)? onImageCaptured;

  const MinorInputCameraPreviewDialog({
    super.key,
  ...
  @override
  State<MinorInputCameraPreviewDialog> createState() =>
      _MinorInputCameraPreviewDialogState();
}

class _MinorInputCameraPreviewDialogState extends State<MinorInputCameraPreviewDialog> {
