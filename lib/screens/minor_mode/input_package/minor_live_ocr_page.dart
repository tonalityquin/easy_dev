...
/// ✅ Minor 파일 내부 전용 mid 정책(외부로 export되지 않음)
...
class MinorLiveOcrPage extends StatefulWidget {
  const MinorLiveOcrPage({super.key});

  @override
  State<MinorLiveOcrPage> createState() => _MinorLiveOcrPageState();
}

class _MinorLiveOcrPageState extends State<MinorLiveOcrPage> {
