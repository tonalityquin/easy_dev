...
class MinorCommuteInInfoCardWidget extends StatelessWidget {
  const MinorCommuteInInfoCardWidget({super.key});
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              _infoRow(cs: cs, icon: Icons.phone, label: 'Tel.', value: formatPhoneNumber(userState.phone)),
              _infoRow(cs: cs, icon: Icons.location_on, label: 'Sector.', value: userState.area),
            ],
          ),
        ),
      ),
