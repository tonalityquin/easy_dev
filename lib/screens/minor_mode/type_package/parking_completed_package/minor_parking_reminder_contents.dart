...
class MinorParkingReminderContents {
  final String title;
  final List<String> lines;

  const MinorParkingReminderContents({
    required this.title,
    required this.lines,
  });
}

const List<MinorParkingReminderContents> kDefaultParkingReminderContents = [
  MinorParkingReminderContents(
    title: 'Test Title',
    lines: [
      '• Test line 1',
      '• Test line 2',
...
final Map<String, List<MinorParkingReminderContents>> kParkingReminderContentsByArea = {
  '가로수길(캔버스랩)': [
    const MinorParkingReminderContents(
      title: '업무 시작 전',
      lines: [
...
List<MinorParkingReminderContents> parkingRemindersForArea(String area) {
  final key = area.trim();
...
const List<MinorParkingReminderContents> kParkingReminderContents = kDefaultParkingReminderContents;
