...
// ✅ 기존 상태 바텀시트 (새 바텀시트 X)
import '../minor_parking_completed_status_bottom_sheet.dart';

import 'keypad/animated_keypad.dart';
import 'widgets/minor_parking_completed_plate_number_display.dart';
import 'widgets/minor_parking_completed_plate_search_header.dart';
import 'widgets/minor_parking_completed_plate_search_results.dart';
import 'widgets/minor_parking_completed_search_button.dart';

class MinorParkingCompletedSearchBottomSheet extends StatefulWidget {
  final void Function(String) onSearch;
  final String area;

  const MinorParkingCompletedSearchBottomSheet({
    super.key,
  ...
  @override
  State<MinorParkingCompletedSearchBottomSheet> createState() =>
      _MinorParkingCompletedSearchBottomSheetState();
}

class _MinorParkingCompletedSearchBottomSheetState
    extends State<MinorParkingCompletedSearchBottomSheet>
  ...
  Future<void> _refreshSearchResults() async {
    ...
    try {
      ...
      // ✅ Minor 모드 요구 범위만: 입차요청 / 입차완료 / 출차요청
  ...
  void _openStatusBottomSheet(BuildContext rootContext, PlateModel selected) {
    ...
    showMinorParkingCompletedStatusBottomSheet(
      context: rootContext,
      plate: selected,
                  ...
                  child: Column(
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          children: [
                            const Expanded(child: MinorParkingCompletedPlateSearchHeader()),
                            IconButton(
                              tooltip: '닫기',
                        ...
                        child: ListView(
                          ...
                          children: [
                            _CardSection(
                              ...
                              subtitle: '예: 1234',
                              accent: _base,
                              child: MinorParkingCompletedPlateNumberDisplay(
                      ...
                      Padding(
                        ...
                        child: ValueListenableBuilder<TextEditingValue>(
                          ...
                          builder: (context, value, child) {
                            ...
                            return MinorParkingCompletedSearchButton(
                              isValid: valid,
