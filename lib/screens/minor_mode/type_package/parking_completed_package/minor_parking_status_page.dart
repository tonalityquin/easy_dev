...
class _MinorParkingStatusPageState extends State<MinorParkingStatusPage> {
...
/// ✅ Google Sheets API 기반 공지 서비스 (Minor)
class MinorParkingNoticeService {
  ...
  static Future<sheets.SheetsApi> _sheetsApi() async {
    try {
      ...
      await _logApiError(
        tag: 'MinorParkingNoticeService._sheetsApi',
  ...
  static Future<String> _loadSpreadsheetId() async {
    try {
      ...
      await _logApiError(
        tag: 'MinorParkingNoticeService._loadSpreadsheetId',
