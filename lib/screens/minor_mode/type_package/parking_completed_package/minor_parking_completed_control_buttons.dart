...
import 'widgets/minor_set_departure_request_dialog.dart';
...
class MinorParkingCompletedControlButtons extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return Consumer<MinorPlateState>(
            ...
            if (index == 0) {
              ...
              if (isZeroZero && !selectedPlate.isLockedFee) {
                ...
                try {
                  ...
                  await context.read<MinorPlateState>().minorUpdatePlateLocally(
              ...
              showDialog(
                context: context,
                builder: (context) => MinorSetDepartureRequestDialog(
