class MinorParkingCompletedRecord {
  final int? id;
  ...
  const MinorParkingCompletedRecord({
    this.id,
  ...
  factory MinorParkingCompletedRecord.fromMap(Map<String, Object?> map) {
    return MinorParkingCompletedRecord(
      id: map['id'] as int?,
