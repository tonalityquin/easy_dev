...
import '../routes.dart';
import '../states/page/normal_hq_state.dart';
import '../states/page/normal_page_info.dart';
...
// ✅ (추가) Normal 엔진 명시적 OFF를 위해 NormalPlateState 접근
import '../states/plate/normal_plate_state.dart';

// ✅ Trace 기록용 Recorder
import 'hubs_mode/dev_package/debug_package/debug_action_recorder.dart';

class NormalHeadquarterPage extends StatelessWidget {
  const NormalHeadquarterPage({super.key});

  @override
  Widget build(BuildContext context) {
    return MultiProvider(
      providers: [
        ChangeNotifierProvider(create: (_) => NormalHqState(pages: normalHqPage)),
      ],
      child: Builder(
        builder: (context) {
          return PopScope(
...
class _BottomArea extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final state = context.watch<NormalHqState>();
...
class _NormalHqModeSwitchButton extends StatelessWidget {
  const _NormalHqModeSwitchButton();
        ...
        child: ElevatedButton.icon(
          ...
          onPressed: () {
            ...
            _trace(
              ...
              '서비스 본사로 전환 버튼',
              meta: <String, dynamic>{
                'screen': 'Normal_headquarter_page',
            ...
            normalPlateState.normalDisableAll();
      ...
      builder: (context, state, child) {
        ...
        return BottomNavigationBar(
          ...
          items: pages
              ...
              .toList(),
          selectedItemColor: palette.normalBase,
          unselectedItemColor: palette.normalDark.withOpacity(.55),
...
ButtonStyle _switchBtnStyle(BuildContext context) {
  ...
  return ElevatedButton.styleFrom(
    backgroundColor: Colors.white,
    foregroundColor: palette.normalDark, // 기존 black → liteDark로 통일
    minimumSize: const Size.fromHeight(48),
    padding: EdgeInsets.zero,
    side: BorderSide(
      color: palette.normalLight.withOpacity(.8), // 기존 grey → liteLight 톤
      width: 1.0,
    ),
