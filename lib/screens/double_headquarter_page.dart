...
import '../routes.dart';
import '../states/page/double_hq_state.dart';
...
ButtonStyle _switchBtnStyle(BuildContext context) {
  ...
  return ElevatedButton.styleFrom(
    backgroundColor: Colors.white,
    foregroundColor: palette.doubleDark, // 기존 black → liteDark로 통일
    minimumSize: const Size.fromHeight(48),
    padding: EdgeInsets.zero,
    side: BorderSide(
      color: palette.doubleLight.withOpacity(.8), // 기존 grey → liteLight 톤
      width: 1.0,
    ),
