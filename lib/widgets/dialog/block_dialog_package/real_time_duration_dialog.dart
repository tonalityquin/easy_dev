...
class _CancelableBlockingDialog extends StatefulWidget {
  ...
  @override
  State<_CancelableBlockingDialog> createState() =>
      _CancelableBlockingDialogState();
}
...
class _CancelableBlockingDialogState extends State<_CancelableBlockingDialog> {
  ...
  bool get _hasPreviewFields {
    ...
    return p.isNotEmpty ||
        l.isNotEmpty ||
        widget.occurredAt != null ||
        (widget.elapsedText ?? '').trim().isNotEmpty;
  }

  TextStyle _titleStyle(ColorScheme cs, TextTheme text) =>
      text.titleMedium!.copyWith(
        fontWeight: FontWeight.w900,
        color: cs.onSurface,
      );

  TextStyle _subStyle(ColorScheme cs, TextTheme text) =>
      text.bodySmall!.copyWith(
        color: cs.onSurfaceVariant,
        height: 1.35,
      );

  TextStyle _labelStyle(ColorScheme cs, TextTheme text) =>
      text.labelMedium!.copyWith(
        fontWeight: FontWeight.w900,
        color: cs.onSurfaceVariant,
      );

  TextStyle _valueStyle(ColorScheme cs, TextTheme text) =>
  ...
  TextStyle _monoValueStyle(ColorScheme cs, TextTheme text) =>
      _valueStyle(cs, text).copyWith(
                ...
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      borderRadius: BorderRadius.circular(14),
                      border:
                          Border.all(color: cs.outlineVariant.withOpacity(.75)),
                    ),
                    child: Column(
                      mainAxisSize: MainAxisSize.min,
                      children: [
