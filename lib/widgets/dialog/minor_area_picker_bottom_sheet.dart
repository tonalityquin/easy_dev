...
const String _minorModeKey = 'minor'; // ✅ Minor 모드만 노출
...
void minorAreaPickerBottomSheet({
                    ...
                    Expanded(
                      child: FutureBuilder<_AreaPickData>(
                        ...
                        builder: (context, snap) {
                          ...
                          return _MinorPickerWithConfirmButton(
...
class _MinorPickerWithConfirmButton extends StatefulWidget {
  final List<String> selectableAreas;
  final String initialSelected;
  final Future<void> Function(String selected) onConfirm;

  const _MinorPickerWithConfirmButton({
    required this.selectableAreas,
  ...
  @override
  State<_MinorPickerWithConfirmButton> createState() => _MinorPickerWithConfirmButtonState();
}

class _MinorPickerWithConfirmButtonState extends State<_MinorPickerWithConfirmButton> {
