...
const String _modeKey = 'normal'; // ✅ Normal 시트는 normal 포함 지역만 노출
...
void normalAreaPickerBottomSheet({
  required BuildContext context,
  required AreaState areaState,
  required NormalPlateState normalPlateState,
}) {
                          ...
                          return _PickerWithConfirmButton(
                            ...
                            onConfirm: (selected) async {
                              ...
                              if (isHeadquarter) {
                                ...
                                Navigator.pushReplacementNamed(rootContext, AppRoutes.normalHeadquarterPage);
                              } else {
                                normalPlateState.normalEnableForTypePages();
                                if (beforeArea != areaState.currentArea) {
                                  normalPlateState.normalSyncWithAreaState();
                                }
                                Navigator.pushReplacementNamed(rootContext, AppRoutes.normalTypePage);
                              }
                            },
                          );
                        },
