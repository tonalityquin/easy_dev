...
class RealTimeSourceRectModalTransition extends StatefulWidget {
  ...
  @override
  State<RealTimeSourceRectModalTransition> createState() =>
      _RealTimeSourceRectModalTransitionState();
}

class _RealTimeSourceRectModalTransitionState
    extends State<RealTimeSourceRectModalTransition> {
  ...
  @override
  void didUpdateWidget(covariant RealTimeSourceRectModalTransition oldWidget) {
  ...
  void _onAnimationStatus(AnimationStatus status) {
    ...
    if (status == AnimationStatus.dismissed &&
      ...
      final info = RealTimeSourceRectModalCollapseInfo(
