...
class PlateMemoWorkspace extends StatefulWidget {
  const PlateMemoWorkspace({
    super.key,
  ...
  @override
  State<PlateMemoWorkspace> createState() => _PlateMemoWorkspaceState();
}

class _PlateMemoWorkspaceState extends State<PlateMemoWorkspace> {
  bool get _pending => widget.controller.text != widget.committedValue;

  void _debug(String message) {
    widget.onDebug?.call(message);
    debugPrint('[PlateMemoWorkspace] $message');
  }
