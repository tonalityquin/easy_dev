...
class _PlateCameraWorkspaceState extends State<PlateCameraWorkspace> {
  ...
  void _debug(String message) {
    ...
    debugPrint('[PlateCameraWorkspace] $message');
  }
  ...
  Future<void> _initializeCamera() async {
    ...
    try {
      ...
      debugPrint('[PlateCameraWorkspace] error=$error\n$stackTrace');
      if (!mounted) return;
      setState(() {
        _isCameraReady = false;
        _initFailed = true;
  ...
  Future<void> _openSavedPhotos() async {
    if (widget.savedPhotosBuilder == null) return;
              ...
              children: [
                Expanded(
                  child: CommonButton(
                    ...
                    onPressed: widget.savedPhotosBuilder == null
                        ? null
                        : _openSavedPhotos,
                  ),
                ),
